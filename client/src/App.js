...
const OPENSEA_LINK = 'https://testnets.opensea.io/collection/squarenft-v03zcygk5y';
  ...
  return (
    <div className="App">
      <div className="container">
        <div className="header-container">
          ...
          {currentAccount === "" 
            ...
            : (
              ...
              <button onClick={askContractToMintNft} className="cta-buttonconnect-wallet-button">
                Mint NFT
              </button>
            )
          }
        ...
        <div>
          <a href={OPENSEA_LINK}>
          <button className="cta-button">🌊 View Collection on OpenSea</button>
          </a>
        </div>
